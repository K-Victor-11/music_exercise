...
class SplashActivity: AppCompatActivity() {
    ...
    fun init(){
        ...
        if (!prefUtils.getBoolean("default_data", false)) {
            ...
            groupList.add(List_HeaderDataModel("개울소리4","개울소리4","water_04", "D"))
            groupList.add(List_HeaderDataModel("개울소리5","개울소리5","water_05","D"))
            groupList.add(List_HeaderDataModel("비소리1","비소리1","rain_01","D"))
            groupList.add(List_HeaderDataModel("비소리2","비소리2","rain_02","D"))
            groupList.add(List_HeaderDataModel("비소리3","비소리3","rain_03","D"))
            groupList.add(List_HeaderDataModel("바람소리1","바람소리1","wind_01", "D"))
            groupList.add(List_HeaderDataModel("바람소리2","바람소리2","wind_02","D"))
            groupList.add(List_HeaderDataModel("파도소리1","파도소리1","wave_01","D"))
            groupList.add(List_HeaderDataModel("파도소리2","파도소리2","wave_02","D"))
            groupList.add(List_HeaderDataModel("화이트노이즈1","화이트노이즈1","whitenoise_01","D"))
            groupList.add(List_HeaderDataModel("화이트노이즈2","화이트노이즈2","whitenoise_02", "D"))
